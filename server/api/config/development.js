...
module.exports = {
  ...
  clientapp_protocol :             process.env.DEV_CLIENTAPP_PROTOCOL || 'https',
  clientapp_host     :             process.env.DEV_CLIENTAPP_HOST     || 'localhost',
  clientapp_port     :    parseInt(process.env.DEV_CLIENTAPP_PORT)    || 8100,

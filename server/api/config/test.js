...
module.exports = {
  ...
  clientapp_protocol :             process.env.TEST_CLIENTAPP_PROTOCOL || 'https',
  clientapp_host     :             process.env.TEST_CLIENTAPP_HOST     || 'localhost',
  clientapp_port     :    parseInt(process.env.TEST_CLIENTAPP_PORT)    || 8100,
